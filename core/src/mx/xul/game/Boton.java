...
public class Boton {
    ...
    public Rectangle getRectangle (float margen) {
        ...
        Rectangle rectSprite = boton.sprite.getBoundingRectangle();
        rectSprite.setWidth(boton.sprite.getWidth()-(2*margen));
        rectSprite.setHeight(boton.sprite.getHeight()-(2*margen));
        rectSprite.setX(boton.sprite.getX()+margen);
        rectSprite.setY(boton.sprite.getY()+margen);
